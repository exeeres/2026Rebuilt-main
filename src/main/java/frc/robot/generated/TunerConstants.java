...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(.1).withKI(0).withKD(0) // AHHHHHHHHHHHHHHHHHH THIS IS SO PAINFUL WHYYYYYYYY.
        .withKS(0).withKV(0.124);               // real.
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.65);
    ...
    private static final boolean kInvertLeftSide = false; // Must be opposite other side.
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.47607421875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.044677734375);
